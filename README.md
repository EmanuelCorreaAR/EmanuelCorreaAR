...
Software Engineer en Naranja X. Actualmente colaboro en el squad de **Help Experience** en el **Hub de Eventos**: una plataforma interna que concentra la experiencia del cliente, consulta eventos en tiempo real y dispara comunicaciones (email, push e in-app). El día a día es **Node**, **Angular** y **AWS**.

### Ahora

- 🔭 **Software Engineer en [Naranja X](https://www.naranjax.com)** — Help Experience
